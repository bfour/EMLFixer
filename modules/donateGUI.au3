...
Global $bitcoinIcon = GUICtrlCreateIcon("S:\sabox\grid\EMLFixer\GUI\bitcoin-button.ico", -1, 10, 10, 100, 150)
...
Global $catAVI = GUICtrlCreateAvi("S:\sabox\grid\templates\donateGUI\small\pusheen_s.avi", -1, 170, 84, 75, 47, BitOR($GUI_SS_DEFAULT_AVI,$ACS_AUTOPLAY))
Global $donateCloseButton = GUICtrlCreateButton("Close", 210, 170, 75, 35)
GUICtrlSetOnEvent(-1, "donateCloseButtonClick")
Global $paypalIcon = GUICtrlCreateIcon("S:\sabox\grid\templates\donateGUI\donate-paypal_small.ico", -1, 120, 10, 170, 71)
GUICtrlSetCursor (-1, 0)
