...
Func _helpGUIShow()
   ...
   If Not IsDeclared("helpForm") Then
	  ...
	  Global $helpForm = GUICreate("EMLFixer Help", 432, 352, -1, -1)
	  ...
	  $instructionsEdit = GUICtrlCreateEdit("", 10, 10, 415, 299, $ES_READONLY, 0)
	  ...
	  $closeButton = GUICtrlCreateButton("Close", 340, 310, 85, 35)
